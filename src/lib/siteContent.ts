...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  footer: {
    about:
      "Італійські марки: EA7 Emporio Armani, Moschino, PINKO, TWINSET, Antony Morato. Возимо напряму від брендів та їхніх офіційних дистриб'юторів, з документами на кожну партію.",
    columns: [
      {
        title: "Магазин",
        links: [
  ...
  hero: {
    ...
    subtitle:
      "EA7, Moschino, Antony Morato, MC2 Saint Barth, PINKO. Оригінал з офіційних постачань, з документами на кожну партію.",
    stats: [
  ...
  services: [
    { title: "Тільки оригінал", text: "Закупівля напряму у брендів та їхніх дистриб'юторів" },
  ...
  about: {
    ...
    heroSubtitle:
      "Ми возимо італійські марки напряму: EA7 Emporio Armani, Moschino, PINKO, TWINSET, Antony Morato, Patrizia Pepe. Без посередників, без сірого імпорту, з повним пакетом документів на кожну партію.",
    story:
    ...
    guaranteeText:
      "Жодного випадку підробки за весь час роботи. Інакше ми просто не вміємо: усе йде через офіційні канали, кожна позиція з документами.",
    values: [
      { title: "Тільки оригінал", text: "Кожна позиція закуповується безпосередньо у брендів або авторизованих дистриб'юторів, з повним пакетом документів." },
      ...
      { title: "Дбайлива доставка", text: "Фірмове пакування, тканинний пакет, заводська коробка виробника. Товар доїжджає в тому вигляді, в якому вийшов зі складу." },
    ],
  },
  delivery: {
    subtitle: "Відправляємо по всій Україні Новою Поштою. Від 3 000 ₴ доставка за наш рахунок.",
    cards: [
      ...
      { eyebrow: "Перевізник", title: "Нова Пошта", text: "Доставляємо у відділення або поштомат на ваш вибір, по всій підконтрольній території України." },
      { eyebrow: "Вартість доставки", title: "Безкоштовно від 3 000 ₴", text: "Замовлення від 3 000 ₴ веземо за свій рахунок. Якщо сума менша, доставку сплачує отримувач за тарифами Нової Пошти." },
      { eyebrow: "Пакування", title: "Дбайливе та захищене", text: "Фірмова упаковка з тканинним пакетом. Взуття та аксесуари їдуть у фабричних коробках виробника." },
    ],
    ...
    faq: [
      { q: "Чи можна замовити доставку кур'єром?", a: "Наразі лише у відділення або поштомати Нової Пошти. Кур'єрську доставку плануємо додати." },
      { q: "Чи можна відмовитися від посилки?", a: "Так. Якщо передумали, просто не викупайте посилку у Новій Пошті. Напишіть нам, і ми залагодимо ситуацію." },
  ...
  returns: {
    subtitle: "Розмір не підійшов або модель не сподобалась? У вас є 14 днів з дня отримання на обмін або повернення коштів.",
    steps: [
      ...
      { title: "Відправте товар", text: "Ми погодимо адресу та спосіб відправки. Зворотну доставку Новою Поштою оплачує покупець (крім випадків браку)." },
      { title: "Отримайте кошти або обмін", text: "Після отримання та перевірки товару повертаємо кошти на картку або відправляємо обраний розмір чи модель. Термін 1–3 робочі дні." },
    ],
    conditions: [
      ...
      "Аксесуари та ювелірні вироби повертаються в оригінальному пакованні з документами.",
      "Парфуми та аромати для дому не підлягають обміну чи поверненню, якщо упаковка розкрита. Виняток: заводський брак.",
    ],
    guaranteeTitle: "Брак це наша відповідальність",
    guaranteeText: "Якщо товар прийшов з виробничим дефектом або не відповідає опису, зворотну доставку беремо на себе і вирішуємо питання позачергово. Достатньо надіслати фото дефекту в Instagram або на e-mail.",
  },
};
