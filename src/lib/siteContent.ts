...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  footer: {
    about:
      "Італійський одяг напряму від брендів. Доставка по всій Україні.",
    columns: [
      {
        title: "Магазин",
        links: [
  ...
  about: {
    ...
    heroSubtitle:
      "EA7 Emporio Armani, Moschino, PINKO, TWINSET, Antony Morato, Patrizia Pepe: італійський гардероб, за яким раніше їздили до Мілана, тепер доїжджає до вас Новою Поштою. Без сірого імпорту, з документами на кожну партію.",
    story:
    ...
    guaranteeText:
      "Жодного випадку підробки за весь час роботи. Ми просто не вміємо інакше: кожна річ проходить через офіційні канали і приїжджає з документами, що це підтверджують.",
    values: [
