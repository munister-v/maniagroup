  ...
  return (
    <>
      ...
      <div className="mt-8 flex gap-3">
        <div className="flex items-center rounded-[2px] border border-line bg-white">
          <button
            type="button"
            onClick={() => setQty((q) => Math.max(1, q - 1))}
            className="flex h-12 w-11 items-center justify-center text-ink transition-colors hover:bg-cloud"
        ...
        <button
          ...
          className="h-12 flex-1 rounded-[2px] bg-ink text-[12px] uppercase tracking-luxe text-paper transition-all hover:-translate-y-px hover:opacity-90 disabled:translate-y-0 disabled:opacity-40"
        >
          {!inStock
            ? "Немає в наявності"
